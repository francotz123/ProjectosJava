...
<%@ page import = "dao.TipoDeAtraccionDao" %>
...
TipoDeAtraccionDao tipoDeAtracciones = (TipoDeAtraccionDao) misession.getAttribute("tipoDeAtracciones");
...
<body>
		...
		<nav class="navbar navbar-dark bg-dark navbar-toggleable-md">
		  ...
		  <a class="navbar-brand" href="./inicioAdmin.jsp">
		  ...
		  <div class="navbar-nav">
		  	<a class="nav-item nav-link active" href="./inicioAdmin.jsp">Inicio </a>
		  	<a class="nav-item nav-link" href="./promociones.jsp">Editar promociones </a>		  	
		  	<a class="nav-item nav-link" href="./atracciones.jsp">Editar atracciones </a>
		  	<a class="nav-item nav-link" href="./altaUsuario.jsp">Editar Usuario </a>
		  	<a class="nav-item nav-link" href="./tiposDeAtracciones.jsp">Tipos de atracciones </a>
